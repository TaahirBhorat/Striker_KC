...
st.markdown("<h1>Ball receipts heatmaps</h1>", unsafe_allow_html=True)


st.image('data/pics/ashley cupido ball receipts.png', caption='Ashley Cupido - PSL 2023/2024')
st.image('data/pics/iqraam rayners ball receipts.png', caption='Iqraam Rayners - PSL 2023/2024')
# col1, col2 = st.rows(2)
# with col1:
